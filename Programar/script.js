...
function loadGeneratedCode() {
    try {
        ...
        console.log('?? C�digo generado por Gemini AI detectado:', codeData.prompt);
        ...
        const message = `? C�digo generado con �xito para: "${codeData.prompt}"

He generado tu aplicaci�n web con:
� **HTML**: Estructura completa y sem�ntica
� **CSS**: Estilos modernos y responsive
� **JavaScript**: Funcionalidades interactivas

Puedes revisar el c�digo en las pesta�as de arriba o hacer cambios directamente. �Qu� te gustar�a modificar?`;
        ...
        console.log('? C�digo cargado en editores');
    } catch (error) {
        console.error('Error cargando c�digo generado:', error);
    }
}
