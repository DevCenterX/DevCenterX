// Script de la sección de Published Apps
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Cargar datos de aplicaciones publicadas desde Firestore
  async function initPublishedAppsData() {
    try {
      ...
      // Cargar proyectos para contar apps publicadas
      try {
        ...
        if (proyectosSnap.exists()) {
          ...
          if (Array.isArray(pData.proyectos)) {
            // Contar apps publicadas y descargas
        ...
        const publishedCountEl = document.getElementById('publishedAppsCount');
      ...
      console.log('✅ Datos de aplicaciones publicadas cargados');

    } catch (e) {
      console.error('❌ Error cargando datos de publicaciones:', e.message);
    }
  }

  initPublishedAppsData();
